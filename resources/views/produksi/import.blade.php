...
@section('title', 'Import File Data RENCANA MIXING MAKING')
@section('content')
    @include('sweetalert::alert')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Import File Data RENCANA MIXING MAKING </h1>
    ...
    <form action="{{ route('import') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" onclick="history.back()" data-dismiss="modal"> Batal</button>
